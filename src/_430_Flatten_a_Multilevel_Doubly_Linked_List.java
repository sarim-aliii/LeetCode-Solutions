...
// that all the nodes appear in a single-level, doubly linked list.
...
// signify no node connects to the upper node of the previous level.
...
class Solution {
    public Node flatten(Node head) {
        ...
        Node temp = head;
        while(temp != null){
            Node t = temp.next;          // to connect it later
            if(temp.child != null){
