// There is a singly-linked list head and we want to delete
// a node node in it.
//
//You are given the node to be deleted node. You will not be
// given access to the first node of head.
//
...
//
//Delete the given node. Note that by deleting the node, we
// do not mean removing it from memory. We mean:
//
...
// and the node to be given node. node should not be the last
